...
function main() {
	...
	$('props-').prepend('the number of walls is '+$('building-').attr('walls')+'<br>');
	$('props-').prepend('the number of windows is '+$('building-').attr('windows')+'<br>');

	// load the plan so we can edit it
	plan('Hallo there. klik on a level to se the informations');
